...
class DirectionAPIState extends State<DirectionAPI> {
                  ...
                  child: SizedBox(
                    ...
                    child: WeMap(
                      ...
                      initialCameraPosition: const CameraPosition(
                        target: LatLng(21.0204086,105.7722741),
                        zoom: 15.0,
                      ),
                    ),
                  ),
  ...
  void onStyleLoadedCallback() async {
    ...
    points.add(LatLng(21.0204086,105.7722741)); //origin Point
    points.add(LatLng(21.0114059063,105.834672425)); //destination Point
